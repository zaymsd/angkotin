                        ...
                        <tr>
                            ...
                            <td>
                                <?php if (is_admin() && $row['status'] === 'pending'): ?>
                                    <a href="konfirmasi.php?id=<?php echo $row['id_setoran']; ?>&action=approve"
                                        class="btn btn-sm btn-success">
                                        <i class="bi bi-check-circle"></i>
                                    </a>
                                    <a href="konfirmasi.php?id=<?php echo $row['id_setoran']; ?>&action=reject"
                                ...
                                <?php if (is_admin()): ?>
                                    <a href="delete.php?id=<?php echo $row['id_setoran']; ?>"
                                        class="btn btn-sm btn-danger btn-delete"
                                        data-name="Setoran <?php echo $row['nama_supir']; ?>">
